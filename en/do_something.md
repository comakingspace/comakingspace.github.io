...
(function () {
  ...
  fetch('https://api.github.com/repos/comakingspace/do-something/issues?state=open&per_page=50')
    .then(function (r) {
    ...
    .then(function (issues) {
      ...
      if (!open.length) {
        ...
        loading.textContent = 'No open tasks at the moment.';
        return;
      }
    ...
    .catch(function () {
      loading.textContent = 'Failed to load tasks. Please try again later.';
    });
